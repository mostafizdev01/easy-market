                      ...
                      <tr key={index}>
                        ...
                        <td className='px-4 py-4 text-sm whitespace-nowrap'>
                          <div className='flex items-center gap-x-2'>
                            <p
                              className={`px-3 py-1 ${bid.category === "Graphics Design" ? "text-blue-500 bg-blue-100" : ""} ${bid.category === "Web Development" ? "text-green-400 bg-green-50" : ""} ${bid.category === "Digital Marketing" ? "text-yellow-500 bg-yellow-100" : ""} font-bold bg-blue-100/60 text-xs  rounded-full`}
                            >
                              Web Development
                            </p>
                          </div>
